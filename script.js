...
const tick02 = document.getElementById('tick02')
const icon12 = document.getElementById('icon12')
tick02.className = 'hidden'
tick01.className = 'hidden'
...
icon12.addEventListener('click',()=>{
    ...
    index02.className = 'block'
    setTimeout(()=>{
        tick02.className = 'block'
    },100)
})

tick02.addEventListener('click',()=>{
    tick01.className = 'block'
    index02.className = 'hidden'
    display01.className = 'hidden'
})